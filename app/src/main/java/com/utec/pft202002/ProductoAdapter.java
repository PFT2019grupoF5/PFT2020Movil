...
public class ProductoAdapter extends ArrayAdapter<Producto> {
    ...
    public View getView(final int pos, View convertView, ViewGroup parent){
        ...
        View rowView = inflater.inflate(R.layout.list_producto, parent, false);

        TextView txtProductoId = (TextView) rowView.findViewById(R.id.txtProductoId);
        TextView txtProductoNombre = (TextView) rowView.findViewById(R.id.txtProductoNombre);
